...
MODEL_PATH=${MODEL_PATH:-$MODELS_ROOT/Qwen2.5-3B-Instruct-webshop-episode-skill-sft-glm-self}
TRAIN_DATA_SIZE=16
VAL_DATA_SIZE=128
GROUP_SIZE=8
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-grpo-sft_qwen2.5_3b_webshop_mean-norm}
