...
# Internal implementation shared by the public EZPoints SFT launcher.
...
# Visual episode-skill analysis with the on-policy vLLM policy.
...
SEED_ANALYSIS_MAX_STEP_SKILLS_PER_TRAJ=${SEED_ANALYSIS_MAX_STEP_SKILLS_PER_TRAJ:-0}
...
PROJECT_NAME=${PROJECT_NAME:-agentic_ezpoints}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-seed_qwen2.5_vl_3b_ezpoints_episode_only_mean-std-norm}
