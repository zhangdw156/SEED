...
case "${MODEL_SIZE}" in
  1.5b) MODEL_LABEL=1.5B; TP=1; ACTOR_MICRO=8; LOGPROB_MICRO=16; OPTIMIZER_OFFLOAD=False; GPU_UTIL=0.6 ;;
  3b) MODEL_LABEL=3B; TP=2; ACTOR_MICRO=4; LOGPROB_MICRO=8; OPTIMIZER_OFFLOAD=False; GPU_UTIL=0.6 ;;
