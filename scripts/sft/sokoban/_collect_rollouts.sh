...
OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/outputs/sokoban_episode_skill_pipeline_qwen25_vl_3b_gemini_self_1440}"
...
echo "Collecting ${NUM_TASKS} x ${ROLLOUTS_PER_TASK} visual Sokoban baseline rollouts in waves of ${TASK_BATCH_SIZE} tasks."
